...
<section className="hero">
  <div className="hero-image-wrapper mt-11 pt-3">
    <picture>
      {/* <!-- Mobile first --> */}
      <source media="(min-width: 768px)" srcSet="./primemart/hero-desktop.webp"fetchpriority="high" />
      <img src="./primemart/hero-mobile.webp" alt="Tech products display" className="hero-img" fetchpriority="high" />
    </picture>
  </div>
